...
![Create Google Group w/ Settings](gsuite-gam-automation/gam_create_group_w_settings.py)

### Revoke Google User Access Tokens
- This script used Gsuite API in order to revoke a user's access tokens.

![Revoke Google Access Tokens](gsuite-gam-automation/gsuite_revoke_user_access_tokens.py)
